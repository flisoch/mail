                ...
                <form action="?&amp;" name=f method=POST>
                    ...
                    <table width=100% cellpadding=2 cellspacing=0 border=0 bgcolor="#C3D9FF">
                        <tr>
                            <td>
                                <input type="button"
                                       onclick="handleMail('ALL', 'MOVETOFOLDER', 'INBOX');event.stopPropagation();"
                                       value="Move to inbox">
                                <input type="button" onclick="handleMail('INBOX', 'DELETE', null);event.stopPropagation();"
                                ...
                                <input type=button onclick="handleMail('ALL', null, null);event.stopPropagation();"
                                       value="Go">
